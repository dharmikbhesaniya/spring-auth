 ...
 * Provides utility methods to generate success and error responses
 * with consistent structure for REST APIs.
 */
public class ApiResponseFactory {
    ...
    public static <T> ResponseEntity<StandardApiResponse<T>> responseBuild(
        ...
        return ResponseEntity
                .status(status)
                .body(StandardApiResponse.<T>builder()
    ...
    /**
     * Builds a success response with custom message, payload, and request.
     */
    public static <T> ResponseEntity<StandardApiResponse<T>> success(
     ...
     */
    public static <T> ResponseEntity<StandardApiResponse<T>> success(HttpStatus status, String message) {
     ...
     */
    public static <T> ResponseEntity<StandardApiResponse<T>> success(HttpStatus status, HttpServletRequest request) {
        return responseBuild(status, null, null, request, true);
    }

    /**
     * Builds a success response with custom message and payload.
     */
    ...
    /**
     * Builds a success response with custom message and request.
     */
    public static ResponseEntity<StandardApiResponse<Void>> success(String message, HttpServletRequest request) {
     ...
     */
    public static <T> ResponseEntity<StandardApiResponse<T>> success(T payload, HttpServletRequest request) {
    ...
    /**
     * Builds an error response with custom message, payload, and request.
     */
    public static <T> ResponseEntity<StandardApiResponse<T>> error(
            String message, T payload, HttpServletRequest request) {
     ...
     */
    public static <T> ResponseEntity<StandardApiResponse<T>> error(HttpStatus status, String message) {
     ...
     */
    public static <T> ResponseEntity<StandardApiResponse<T>> error(HttpStatus status, HttpServletRequest request) {
        return responseBuild(status, null, null, request, false);
    }

    /**
     * Builds an error response with custom message and payload.
     */
    ...
    /**
     * Builds an error response with custom message and request.
     */
    public static ResponseEntity<StandardApiResponse<Void>> error(String message, HttpServletRequest request) {
     ...
     */
    public static <T> ResponseEntity<StandardApiResponse<T>> error(T payload, HttpServletRequest request) {
